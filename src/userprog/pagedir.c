...
The new page table contains Pintos’s normal kernel virtual page mappings,
...
/*
Activates pd.
The active page table is the one used by the CPU to
translate memory references

recall that each process has a page table, the kernel mapping are same.
*/
void
